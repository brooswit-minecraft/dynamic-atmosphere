...
class VaporHostileSpawnGateTest {
    ...
    void endermenAreNotSpecialCased() {
        // ATMO-19: the Enderman exemption (and the independent Ender Gas spawn gate it used) is
    ...
    @Test
    void endermenOutsideTheOverworldAreNeverGatedByVaporOrEnderGas() {
        // Vapor gating is Overworld-only (ATMO-9) and Ender Gas never gates spawning at all
