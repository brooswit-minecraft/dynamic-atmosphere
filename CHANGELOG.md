...
- Add Dust from movement, jumps/landings, fall damage, block breaking/placement, and falling-block landing. Water-to-mud chance rises from zero at 50% fullness to 100% at capacity, costing half the current amount rounded up on success. Above capacity, a 1/16 roll can place gravel in air without consuming Dust. A separate 1/64 roll dissipates up to 40 units.
