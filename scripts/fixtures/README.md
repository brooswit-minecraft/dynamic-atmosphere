...
Per ATMO-15 ticket comment 22721, these are committed verbatim from the
sickos side (built first):

- Source: `brooswit-minecraft/sickos` path
  `tests/fixtures/dynamic-atmosphere-released.example.json` at commit
  `9150466b6a8e4a5fd36058f41421e86fd6fa1ee5` (sickos PR #29 head).
